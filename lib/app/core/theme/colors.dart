...
class AppColors {
  ...
  static  Color lightGrey = Color(0xFFF5F5F5);
    static  Color boldGrey = Color(0xEEEEEE);



  static const Color background= Color.fromRGBO(16, 25, 32, 0.8);
  static const Color background1= Color.fromRGBO(135, 165, 200, 1.0);
